...
<body>
    <div class="header">
        <div class="profile-info">
            ...
            <p> He also serves as an <a href="https://www.cst.cam.ac.uk/people/pm576" target="_blank">Affiliate Lecturer</a> at the Department of Computer Science and Technology, University of Cambridge, where he co-lectures Machine Learning for Language Processing.</p>
            <p>Before Google DeepMind, Pushkar was at <a href="https://ai.meta.com/people/1323082615033893/pushkar-mishra/" target="_blank">Meta AI (ex-Facebook AI)</a>, where he led the company-wide effort on robust recommender systems and contributed to the pivotal initiative on open-source foundation models as one of the authors of Llama 2.</p>
        </div>
